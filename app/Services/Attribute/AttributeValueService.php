...
class AttributeValueService extends BaseService {
    ...
    public function paginate($request){
        ...
        $users = $this->attributeValueRepository->pagination($agruments);
        return $users;
    }
    ...
    public function create($request){
        ...
        try {
            ...
            $user = $this->attributeValueRepository->create($payload);
            DB::commit();
            return true;
        } catch (\Exception $e) {
           DB::rollback();
    ...
    public function update($request, $id){
        ...
        try {
            ...
            $user = $this->attributeValueRepository->update($id, $payload);
