            ...
            $("#product-table-body").append(`   
                    <tr id="product-row-${product.sku}" data-sku="${product.sku}">
                       <td>
                        ...
                        <td>${product.sku}</td> 
                        <td class="text-wrap">${product.name} ${product.title !== undefined ? ' - ' + product.title : ''}</td>
                        <td class='fix-input'>
                            <input type="number" value="1" class="product-quantity form-control" data-price="${product.price
                    ...
                    product.total ?? product.price * 1
                        ...
                        <td class="hidden">
                            ...
                            <input type="text" name="total[]" value="${product.total ?? product.price * 1
                }">
                        </td>
                    </tr>
                `);
