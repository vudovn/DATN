<div class="filterProduct">
    ...
    <div class="card-body" id="productInputContainer">
        ...
        <div class="filterProduct">
            <div class="card-header">
                <div class="title alert alert-danger" style="transition: background-color 0.3s ease;" role="alert">Bạn
                    phải thêm ít nhất là 3 sản phẩm mới hoàn thành bộ sưu tập! <span style="cursor: pointer"
                        href="#" data-show="show" class="me-3 link-success add-product">Thêm sản phẩm</span></div>
                @error('idProduct')
            ...
            <div class="card-body show-product">
                ...
                <p class="text-primary m-0 mt-2">Đã chọn: <span class="text-danger"><span class="countProduct">0</span>
                        sản phẩm.</span></p>
                <div id="content">
