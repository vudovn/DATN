    {{-- @foreach ($products as $key => $product) --}}
        <div class="cart-item" id="cart-item-{{ $product->idCart }}" data-productSku="{{$product->product->sku ?? $product->sku}}"
            data-id="{{ $product->idCart }}" style="z-index: {{$zIndex}};">
            ...
            <div class="cart-item-remove">
                <button type="button" data-id="{{ $product->idCart }}" data-productSku="{{$product->product->sku ?? $product->sku}}"
