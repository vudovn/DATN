                    ...
                    <div class="cart-container">
                        ...
                        @else
                            <div class="container cart-no-item text-center mb-4 pt-15">
                                <img src="{{ asset('uploads/image/system/no_product.webp') }}" alt=""
                                    width="100">
                    ...
                    @if (count($discountCollection) > 0)
                        ...
                        <div class="collapse" id="discount-collection">
                            <div class="card card-body">
                                ...
                                thể trong thời gian khuyến mãi. Mức giảm giá có thể dao động từ 1% đến 50% tùy từng bộ sưu
                                tập
                                và chương trình ưu đãi. Khách hàng sẽ có cơ hội sở hữu những sản phẩm chất lượng với mức giá
                                hấp
