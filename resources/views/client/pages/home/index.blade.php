...
@section('content')
    <div class="home">
                        ...
                        <div id="carouselExampleControls" class="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <div class="product-card">
                                        <a href="#"><img src="/client_asset/image/home/best _seller_2.jpg"
                                                alt="Product 1" /></a>
                                        <p class="best-seller-title">Bán chạy</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="product-card">
                                        <a href="#"><img src="/client_asset/image/home/best _seller_3.jpg"
                                                alt="Product 1" /></a>
                                        <p class="best-seller-title">Bán chạy</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="product-card">
                                        <a href="#"><img src="/client_asset/image/home/best _seller_1.jpg"
                                                alt="Product 1" /></a>
                                        <p class="best-seller-title">Bán chạy</p>
                                    </div>
                                </div>
        ...
        <section class="banner-collection">
            <!-- 7. Living room -->
            @foreach ($categoryRoom as $room)
                <div class="banner mb-2">
                    <img src="{{ asset($room->thumbnail) }}" alt="Banner Image" />
                    <div class="overlay"></div>
                    <div class="banner-collection-title">
                        <h1 class="text-white">{{ $room->name }}</h1>
                        <a href="{{ route('client.category.index', $room->slug) }}" class="lead text-white">Xem sản phẩm <i class="bi bi-chevron-right"></i></a>
                    </div>
                </div>
            @endforeach
        </section>
