    ...
    <div class="wishlist-product row animate__animated animate__fadeIn">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 col-6 d-flex justify-content-center mb-4">
                <div class="card rounded overflow-hidden custom-card border-0">
                    <div class="position-relative" style="background-color: #EBEBEB;">
                        <img src="{{ asset('client_asset/image/product/' . ($product->image ?? 'wishlist3.png')) }}" class="card-img-top" alt="...">
                        <div class="con-like position-absolute top-0 end-0 mt-2 me-3">
                            <input class="like add_wishlist" type="checkbox" 
                                   data-id="{{ $product->id }}" 
                                   data-type="remove" 
                                   checked title="like">
                            <div class="checkmark">
                    ...
                    <div class="card-body p-0 mt-2">
                        <h5 class="card-text"><a href="#">{{ $product->name }}</a></h5>
        ...
        <!-- Thêm các cột tương tự với class `col-md-6 col-lg-4 col-xl-3` cho các phần tử khác -->
    </div>
